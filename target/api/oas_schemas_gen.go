...
type GetMetricsYggBadRequest DefaultErrorObj

func (*GetMetricsYggBadRequest) getMetricsYggRes() {}

type GetMetricsYggInternalServerError DefaultErrorObj

func (*GetMetricsYggInternalServerError) getMetricsYggRes() {}

type GetMetricsYggMethodNotAllowed DefaultErrorObj

func (*GetMetricsYggMethodNotAllowed) getMetricsYggRes() {}

type GetMetricsYggNotFound DefaultErrorObj

func (*GetMetricsYggNotFound) getMetricsYggRes() {}

type GetMetricsYggRequestHeaderFieldsTooLarge DefaultErrorObj

func (*GetMetricsYggRequestHeaderFieldsTooLarge) getMetricsYggRes() {}

type GetMetricsYggRequestURITooLong DefaultErrorObj

func (*GetMetricsYggRequestURITooLong) getMetricsYggRes() {}
...
type GetVersionArtifactServiceUnavailable DefaultErrorObj

func (*GetVersionArtifactServiceUnavailable) getVersionArtifactRes() {}
...
type GetVersionFileServiceUnavailable DefaultErrorObj

func (*GetVersionFileServiceUnavailable) getVersionFileRes() {}
...
type InfoObj struct {
	...
	// Build version of the running node from compiled build metadata.
...
// Yggdrasil mesh peer metrics snapshot. Aggregates come from the prebuilt telemetry snapshot.
// Ref: #/components/schemas/MetricsYggObj
type MetricsYggObj struct {
	// Peers currently selected by the peer manager; 0 without a manager. Updates once per probe cycle, so
	// it can lag the connected state by up to ygg.peers.probe_timeout.
	ActiveSelected int64 `json:"active_selected"`
	// Lowest measured latency among connected peers in nanoseconds; omitted when unknown.
	BestLatencyNanos OptInt64 `json:"best_latency_nanos"`
	// Peer-manager isolation notifications observed since process start. Delivery is best-effort and rapid
	// bursts coalesce, so this is a lower bound on isolation episodes.
	NoReachableNotificationsTotal int64 `json:"no_reachable_notifications_total"`
	// Point-in-time peer list. Present only when internal metrics are enabled for the current entry
	// (`metrics.web.internal` or `metrics.ygg.internal`); the public response carries aggregates only,
	// because per-peer data exposes direct topology. Capped at 256 entries and refreshed at most once per
	// metrics.snapshot_interval; exact totals live in the aggregate counters. Per-peer data is also
	// intentionally absent from the Prometheus exposition.
	Peers []MetricsYggPeerObj `json:"peers"`
	// Peers that initiated their connection to this node.
	PeersInbound int64 `json:"peers_inbound"`
	// Peers known to the node, configured and inbound.
	PeersKnown int64 `json:"peers_known"`
	// Peers with a currently connected link.
	PeersUp int64 `json:"peers_up"`
	// Bytes received across current peer connections.
	RxBytes int64 `json:"rx_bytes"`
	// Bytes transmitted across current peer connections.
	TxBytes int64 `json:"tx_bytes"`
}

// GetActiveSelected returns the value of ActiveSelected.
func (s *MetricsYggObj) GetActiveSelected() int64 {
	return s.ActiveSelected
}

// GetBestLatencyNanos returns the value of BestLatencyNanos.
func (s *MetricsYggObj) GetBestLatencyNanos() OptInt64 {
	return s.BestLatencyNanos
}

// GetNoReachableNotificationsTotal returns the value of NoReachableNotificationsTotal.
func (s *MetricsYggObj) GetNoReachableNotificationsTotal() int64 {
	return s.NoReachableNotificationsTotal
}

// GetPeers returns the value of Peers.
func (s *MetricsYggObj) GetPeers() []MetricsYggPeerObj {
	return s.Peers
}

// GetPeersInbound returns the value of PeersInbound.
func (s *MetricsYggObj) GetPeersInbound() int64 {
	return s.PeersInbound
}

// GetPeersKnown returns the value of PeersKnown.
func (s *MetricsYggObj) GetPeersKnown() int64 {
	return s.PeersKnown
}

// GetPeersUp returns the value of PeersUp.
func (s *MetricsYggObj) GetPeersUp() int64 {
	return s.PeersUp
}

// GetRxBytes returns the value of RxBytes.
func (s *MetricsYggObj) GetRxBytes() int64 {
	return s.RxBytes
}

// GetTxBytes returns the value of TxBytes.
func (s *MetricsYggObj) GetTxBytes() int64 {
	return s.TxBytes
}

// SetActiveSelected sets the value of ActiveSelected.
func (s *MetricsYggObj) SetActiveSelected(val int64) {
	s.ActiveSelected = val
}

// SetBestLatencyNanos sets the value of BestLatencyNanos.
func (s *MetricsYggObj) SetBestLatencyNanos(val OptInt64) {
	s.BestLatencyNanos = val
}

// SetNoReachableNotificationsTotal sets the value of NoReachableNotificationsTotal.
func (s *MetricsYggObj) SetNoReachableNotificationsTotal(val int64) {
	s.NoReachableNotificationsTotal = val
}

// SetPeers sets the value of Peers.
func (s *MetricsYggObj) SetPeers(val []MetricsYggPeerObj) {
	s.Peers = val
}

// SetPeersInbound sets the value of PeersInbound.
func (s *MetricsYggObj) SetPeersInbound(val int64) {
	s.PeersInbound = val
}

// SetPeersKnown sets the value of PeersKnown.
func (s *MetricsYggObj) SetPeersKnown(val int64) {
	s.PeersKnown = val
}

// SetPeersUp sets the value of PeersUp.
func (s *MetricsYggObj) SetPeersUp(val int64) {
	s.PeersUp = val
}

// SetRxBytes sets the value of RxBytes.
func (s *MetricsYggObj) SetRxBytes(val int64) {
	s.RxBytes = val
}

// SetTxBytes sets the value of TxBytes.
func (s *MetricsYggObj) SetTxBytes(val int64) {
	s.TxBytes = val
}

// MetricsYggObjHeaders wraps MetricsYggObj with response headers.
type MetricsYggObjHeaders struct {
	CacheControl OptString
	Response     MetricsYggObj
}

// GetCacheControl returns the value of CacheControl.
func (s *MetricsYggObjHeaders) GetCacheControl() OptString {
	return s.CacheControl
}

// GetResponse returns the value of Response.
func (s *MetricsYggObjHeaders) GetResponse() MetricsYggObj {
	return s.Response
}

// SetCacheControl sets the value of CacheControl.
func (s *MetricsYggObjHeaders) SetCacheControl(val OptString) {
	s.CacheControl = val
}

// SetResponse sets the value of Response.
func (s *MetricsYggObjHeaders) SetResponse(val MetricsYggObj) {
	s.Response = val
}

func (*MetricsYggObjHeaders) getMetricsYggRes() {}

// One Yggdrasil peer connection at snapshot time.
// Ref: #/components/schemas/MetricsYggPeerObj
type MetricsYggPeerObj struct {
	// Routing cost through the peer.
	Cost int64 `json:"cost"`
	// Whether the peer initiated the connection.
	Inbound bool `json:"inbound"`
	// Latest error observed on the peer link; omitted when none.
	LastError OptString `json:"last_error"`
	// When the latest peer error occurred; omitted when none.
	LastErrorTime OptDateTime `json:"last_error_time"`
	// Measured peer latency in nanoseconds; 0 when unknown.
	LatencyNanos int64 `json:"latency_nanos"`
	// Hexadecimal peer public key; omitted while the peer has never completed a handshake.
	PublicKey OptString `json:"public_key"`
	// Bytes received over the current connection.
	RxBytes int64 `json:"rx_bytes"`
	// Bytes transmitted over the current connection.
	TxBytes int64 `json:"tx_bytes"`
	// Whether the peer link is currently connected.
	Up bool `json:"up"`
	// Connection age in seconds as reported by the node.
	UptimeSeconds float64 `json:"uptime_seconds"`
	// Configured or inbound peer URI with userinfo credentials stripped; omitted when unknown or
	// unparsable.
	URI OptString `json:"uri"`
}

// GetCost returns the value of Cost.
func (s *MetricsYggPeerObj) GetCost() int64 {
	return s.Cost
}

// GetInbound returns the value of Inbound.
func (s *MetricsYggPeerObj) GetInbound() bool {
	return s.Inbound
}

// GetLastError returns the value of LastError.
func (s *MetricsYggPeerObj) GetLastError() OptString {
	return s.LastError
}

// GetLastErrorTime returns the value of LastErrorTime.
func (s *MetricsYggPeerObj) GetLastErrorTime() OptDateTime {
	return s.LastErrorTime
}

// GetLatencyNanos returns the value of LatencyNanos.
func (s *MetricsYggPeerObj) GetLatencyNanos() int64 {
	return s.LatencyNanos
}

// GetPublicKey returns the value of PublicKey.
func (s *MetricsYggPeerObj) GetPublicKey() OptString {
	return s.PublicKey
}

// GetRxBytes returns the value of RxBytes.
func (s *MetricsYggPeerObj) GetRxBytes() int64 {
	return s.RxBytes
}

// GetTxBytes returns the value of TxBytes.
func (s *MetricsYggPeerObj) GetTxBytes() int64 {
	return s.TxBytes
}

// GetUp returns the value of Up.
func (s *MetricsYggPeerObj) GetUp() bool {
	return s.Up
}

// GetUptimeSeconds returns the value of UptimeSeconds.
func (s *MetricsYggPeerObj) GetUptimeSeconds() float64 {
	return s.UptimeSeconds
}

// GetURI returns the value of URI.
func (s *MetricsYggPeerObj) GetURI() OptString {
	return s.URI
}

// SetCost sets the value of Cost.
func (s *MetricsYggPeerObj) SetCost(val int64) {
	s.Cost = val
}

// SetInbound sets the value of Inbound.
func (s *MetricsYggPeerObj) SetInbound(val bool) {
	s.Inbound = val
}

// SetLastError sets the value of LastError.
func (s *MetricsYggPeerObj) SetLastError(val OptString) {
	s.LastError = val
}

// SetLastErrorTime sets the value of LastErrorTime.
func (s *MetricsYggPeerObj) SetLastErrorTime(val OptDateTime) {
	s.LastErrorTime = val
}

// SetLatencyNanos sets the value of LatencyNanos.
func (s *MetricsYggPeerObj) SetLatencyNanos(val int64) {
	s.LatencyNanos = val
}

// SetPublicKey sets the value of PublicKey.
func (s *MetricsYggPeerObj) SetPublicKey(val OptString) {
	s.PublicKey = val
}

// SetRxBytes sets the value of RxBytes.
func (s *MetricsYggPeerObj) SetRxBytes(val int64) {
	s.RxBytes = val
}

// SetTxBytes sets the value of TxBytes.
func (s *MetricsYggPeerObj) SetTxBytes(val int64) {
	s.TxBytes = val
}

// SetUp sets the value of Up.
func (s *MetricsYggPeerObj) SetUp(val bool) {
	s.Up = val
}

// SetUptimeSeconds sets the value of UptimeSeconds.
func (s *MetricsYggPeerObj) SetUptimeSeconds(val float64) {
	s.UptimeSeconds = val
}

// SetURI sets the value of URI.
func (s *MetricsYggPeerObj) SetURI(val OptString) {
	s.URI = val
}
